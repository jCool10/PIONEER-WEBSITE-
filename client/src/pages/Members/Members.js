  ...
  return (
    <section className="container">
      ...
      <SliderCard
        rows={1}
        slidesToShow={2}
        members={listMember.filter((member) => member.role === "memberLead")}
      />
      ...
      <SliderCard
        rows={1}
        slidesToShow={3}
        members={listMember.filter((member) => member.role === "teamLeader")}
      />
      ...
      <SliderCard
        rows={2}
        slidesToShow={3}
        members={listMember.filter((member) => member.role === "member")}
      />
    </section>
  );
}
